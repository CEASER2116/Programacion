#include <stdio.h>
/* Examen de admisión.
El programa, al recibir como dato un archivo de acceso directo que contiene información sobre los alumnos que presentaron el examen de admisión a una universidad, genera información importante para el Departamento de Control
Escolar. */

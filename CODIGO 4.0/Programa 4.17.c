...
El programa permite calcular el promedio mensual de las lluvias caídas en
 tres regiones importantes del país. Determina también cuál es la región con mayor promedio de lluvia anual. */
...
if (R1 > R2)
if (R1 > R3)
printf("\nRegión con mayor promedio: Región Golfo. Promedio: %6.2f",12);
